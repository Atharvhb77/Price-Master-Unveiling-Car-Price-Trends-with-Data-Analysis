...
You can either run our code locally or access our online hosted website https://pricemaster.streamlit.app/ :)


To set up the platform locally, follow these steps:
1. Clone the repository.(https://github.com/msrinag/Price_Master/tree/main)
2. Open a cmd and navigate to src\phase3\Price_Master-main
3. Install dependencies using `pip install -r requirements.txt`.
4. Run the main script `1_search_cars.py` using Streamlit: `python -m streamlit run 1_search_cars.py`.
